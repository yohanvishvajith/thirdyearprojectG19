...
<head>
    ...
    <link href="{{asset('import/assets/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" >
    <link href="{{asset('import/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i&amp;display=swap')}}" rel="stylesheet" >
    <link href="{{asset('import/https://fonts.googleapis.com/css?family=ABeeZee&amp;display=swap')}}" rel="stylesheet">
    <link href="{{asset('import/assets/fonts/fontawesome-all.min.css')}}" rel="stylesheet" >
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="border: 2.5px none var(--bs-black);padding: 0px;">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>450</td>
                                        <td>450</td>
                                        <td class="text-center" style="padding: 0px;"><button class="btn btn-primary" type="button" style="background: var(--bs-teal);border-width: 0px;margin: 5px;margin-right: 0px;height: 30px;width: 61.8px;padding: 0px;position: static;display: inline-block;">Update</button><button class="btn btn-primary" type="button" style="background: var(--bs-red);border-width: 0px;margin: 5px;margin-right: 0px;height: 30px;width: 61.8px;padding: 0px;text-align: center;position: sticky;display: inline;">Delete</button></td>
                    ...
                    <div style="padding: 30px;border-style: solid;">
                        <form>
                            <h3 class="text-dark mb-4">Black List</h3><label class="form-label">ID</label><input class="form-control" type="text">
                            <div style="height: 12px;"></div><button class="btn btn-primary" type="button" style="margin: 0px;padding: 5px 5px;height: 35px;">Add to Backlist</button>
                        </form>
                    </div>
